...
import { projectsAPI, modulesAPI, Project, Module, ProjectModule } from '../services/api';
                            ...
                            return (
                                ...
                                >
                                    <div className="flex items-start justify-between mb-3">
                                        <div className={`w-12 h-12 rounded-xl flex items-center justify-center ${isEnabled ? 'bg-green-500' : 'bg-gradient-to-br from-primary-500 to-secondary-500'
                                            }`}>
